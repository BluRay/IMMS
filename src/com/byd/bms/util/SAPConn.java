...
public class SAPConn {
    ...
    static{ 
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_ASHOST, "192.168.100.11");//服务器  
        ...
        connectProperties.setProperty(DestinationDataProvider.JCO_USER,   "tanmeirong");  //SAP用户名  
        connectProperties.setProperty(DestinationDataProvider.JCO_PASSWD, "20110101");     //密码  
