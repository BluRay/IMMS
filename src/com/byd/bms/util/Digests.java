...
public class Digests {
	...
	public static byte[] md5(byte[] input, int iterations) throws GeneralSecurityException {
	 ...
	 * @throws GeneralSecurityException 
	 */
	private static byte[] digest(byte[] input, String algorithm, byte[] salt, int iterations) throws GeneralSecurityException {
		try {
	...
	private static byte[] digest(InputStream input, String algorithm) throws IOException, GeneralSecurityException {
		try {
