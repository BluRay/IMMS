	...
	$("#tableData").dataTable({
		...
		columns: [
            ...
            {"title":"操作 ","class":"center","data":"order_State","defaultContent": "","render":function(data,type,row){
            	var str='<a href=/BMS/process/display?processId='+row.process_Id+'&orderId='+row.id+' " class="btnPict" title="审批详情">审批详情</a>'+
				'  <a href=/BMS/flow/all?processId='+row.process_Id+'&orderId='+row.id+'&type=cc class="btnEdit" title="流程信息">流程信息</a>';
            	return str;
            }}
        ],
	});
