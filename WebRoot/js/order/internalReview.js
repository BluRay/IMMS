								...
								content: [
									{
										...
										table: {
											...
											body: [
												...
												['', '','签字',data.technical_operator,'日期', {colSpan: 2, text: data.technical_create_time},''],
												...
												['', '','签字',data.technology_operator,'日期', {colSpan: 2, text: data.technology_create_time},''],
												...
												['', '','签字',data.quality_operator,'日期', {colSpan: 2, text: data.quality_create_time},''],
												...
												['', '','签字',data.factory_operator,'日期', {colSpan: 2, text: data.factory_create_time},''],
												...
												['', '','签字',data.planning_operator,'日期', {colSpan: 2, text: data.planning_create_time},''],
												...
												['', '','签字',data.plandep_operator,'日期', {colSpan: 2, text: data.plandep_create_time},''],
