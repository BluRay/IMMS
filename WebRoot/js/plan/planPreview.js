	    ...
	    success:function(response){		    		
    		...
    		$.each(response.data,function (index,value) {
    			...
    			if(index%12 == 0){
    	    		...
    	    		$("<td style=\"text-align:center;line-height:12px;\" />").html("节点").appendTo(tr);
    	    		$("<td style=\"text-align:center;line-height:12px;\" />").html("月份").appendTo(tr);
    	    		$("<td style=\"text-align:center;padding-left:0px;padding-right:0px;\" width=\"30px\" />").html("库存").appendTo(tr);
    			...
    			tr = $("<tr />");
    			$("<td style=\"text-align:center;line-height:12px;padding-left:0px;\" />").html(value.plan_code_keyname).appendTo(tr);
