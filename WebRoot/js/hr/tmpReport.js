...
$(document).ready(function() {
	...
	$(document).on("click",".buttons-excel",function(){
		...
		htmlToExcel("tableResult", "", "","额外工时统计","额外工时统计");
		return false;
	});
});
...
function ajaxQuery(){
	...
	columns= [
        ...
        {"title":"车间","width":"80","class":"center","data":"workshop_org","defaultContent": ""},		            
        ...
        {"title":"额外工资","class":"center","data": "salary","defaultContent": ""}	
      ]	;
...
function ajaxQuery2(){
	...
	columns= [
        ...
        {"title":"小班组","class":"center","data": "team_org","defaultContent": ""},
        {"title":"操作日期","class":"center","data":"work_date","defaultContent": ""},
        {"title":"技改单","class":"center","width":"160","data":"tmp_order_num","defaultContent": ""},
