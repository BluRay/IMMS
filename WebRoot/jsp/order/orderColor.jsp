...
<body class="no-skin" style="font-family: 'Microsoft YaHei';">
			...
			<div id="dialog-order" class="hide">
				<form id="" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="input-large"
								placeholder="客户..." id="edit_customer" disabled="disabled"/>
						</div>
					</div> 
					<div class="form-group">
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input class="input-large" style="height: 30px;" placeholder="生产年份.." id="edit_productive_year" 
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<input type="text" class="input-large" placeholder="选择订单交期..." disabled
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<!-- <input type="text" class="input-large" placeholder="选择订单交期..." id="bmsFactoryOrder" /> -->
					...
					<div class="form-group">
						...
						<div class="col-sm-9">
							<textarea class="input-xlarge" style="width: 355px" disabled
	...
	<script src="../js/order/orderColor.js"></script>
</body>
