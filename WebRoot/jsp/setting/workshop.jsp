			...
			<div class="main-content-inner">
				...
				<div class="page-content">
					<div id="form" class="well form-search">
						<table>
							<tr>
								<td>车间：</td>
								<td><input type="text" style="height: 30px;" class="input-medium revise" placeholder="请输入车间..." value="" id="search_workshop" /></td>
				...
				<div id="dialog-add" class="hide">
					<form id="addForm" class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 col-sm-3 control-label no-padding-right no-padding-right" for="addFactoryName">*&nbsp;车间名称</label>
							<div class="col-sm-9">
								<input type="text" class="input-medium" placeholder="车间名称..." id="addWorkshopName" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 col-sm-3 control-label no-padding-right no-padding-right" for="addWorkshopCode">*&nbsp;车间代码</label>
							<div class="col-sm-9">
								<input type="text" class="input-medium" placeholder="车间代码..." id="addWorkshopCode" />
							</div>
						</div>
				...
				<div id="dialog-edit" class="hide">
					<form id="editForm" class="form-horizontal">
						<div class="form-group">
							<label class="col-sm-3 col-sm-3 control-label no-padding-right no-padding-right" for="editWorkshopName">*&nbsp;车间名称</label>
							<div class="col-sm-9">
								<input type="hidden" id="editId" />
								<input type="text" class="input-medium" placeholder="车间名称..." id="editWorkshopName" />
							</div>
						</div>
						<div class="form-group">
							<label class="col-sm-3 col-sm-3 control-label no-padding-right no-padding-right" for="editWorkshopCode">*&nbsp;车间代码</label>
							<div class="col-sm-9">
								<input type="text" class="input-medium" placeholder="车间代码..." id="editWorkshopCode" />
							</div>
						</div>
