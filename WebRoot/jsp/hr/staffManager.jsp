								...
								<div id="div_tree2" class="widget-box widget-color-blue2" style="height:515px;OVERFLOW-X:auto;OVERFLOW-Y:auto;OVERFLOW:auto">
									...
									<div class="well">
										<table>
											<tr>
												<td>工号/姓名:</td>
												<td colspan=3><input id="search_staff_number" style="height: 30px;" placeholder="请输入工号/姓名..." class="col-sm-9" type="text"></td>
									...
									<button id="btnBulkHide" type="button" class="close"><i class="ace-icon fa fa-times"></i></button>
										...
										<table>
											<tr>
												...
												<td></td><td><a href="../docs/staff_upload.xls">下载批导模板</a></td>
											</tr>
										</table>
										</form>
									</div>
