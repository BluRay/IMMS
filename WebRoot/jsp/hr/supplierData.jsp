...
<body class="no-skin" style="font-family: 'Microsoft YaHei';">
						...
						<table>
							<tr>
								...
								<td>
 								...
 								<td>负责人：</td>
								<td><input style="height: 30px;width:130px;" type="text" class="input-medium revise" placeholder="负责人..." id="search_dutyman" /></td> 						
								<td>
	...
	<script src="../js/hr/supplierData.js"></script>
</body>
