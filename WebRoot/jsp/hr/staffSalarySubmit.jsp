						...
						<tr>
							...
							<td >
								<input id="month" style="width:90px;height: 30px;" class="input-small" 
											onclick="WdatePicker({dateFmt:'yyyy-MM',minDate:'%y-{%M-2}',maxDate:'%y-%M'})" type="text">						
							</td>
							<td>
							<input class="btn btn-sm btn-primary" id="btnQuery" value="查询" style="margin-left: 10px;top:1px;" type="button">	
							<input class="btn btn-sm btn-success" id="btnSubmit" value="提交" style="margin-left: 10px;top:1px;" type="button">							
							</td>
						</tr>						
						</table>
					</form>
