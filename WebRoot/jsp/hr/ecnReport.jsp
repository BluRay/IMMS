...
<html lang="zh-CN">
		...
		<div class="main-container" id="main-container">
			...
			<div class="page-content">
					...
					<form id="search_form" class="well form-search">
						...
						<td colspan='2' style="text-align:right">技改任务：</td>
						<td colspan='2'><input id="search_task" style="width:143px;height: 30px;" class="input-medium" placeholder="技改任务" type="text"></td>
						<td>&nbsp;统计维度：</td>
						<td>
	...
	<script src="../js/hr/ecnReport.js"></script>
</html>
