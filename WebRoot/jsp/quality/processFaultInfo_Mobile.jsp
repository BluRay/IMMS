				...
				<div class="page-content" style="position:fixed;top:38px;bottom:10px;width:100%;overflow-y:auto;padding-left: 0px;padding-right:12px;">
					<form class="form-horizontal" id="scan_form">
						<div class="form-group">
							...
							<div class="col-xs-9">
								<span class="input-icon input-icon-right" style="width: 100%;">
										...
										<input id="new_id" type="text" class="input-medium" style="display:none">
								</span>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select id="new_fault_level" class="form-control" style="width:100%">
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select id="new_is_batch" class="form-control" style="width:100%">
								<option value="">请选择</option>
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select id="new_factory" class="form-control" style="width:100%"></select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 control-label no-padding-right">车辆型号:</label>
							<div class="col-xs-9">
								<select id="new_bus_type" class="form-control" style="width:100%">
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select id="new_response_factory" class="form-control" style="width:100%"></select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 control-label no-padding-right">责任车间:</label>
							<div class="col-xs-9">
								<select id="new_workshop" class="form-control" style="width:100%"></select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select class="form-control" id="new_resolve_result" style="width:100%"><option value="0">关闭</option><option value="1">受理</option></select>
							</div>
						</div>
						<div class="form-group">
