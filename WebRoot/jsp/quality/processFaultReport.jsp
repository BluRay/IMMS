...
<!-- 			<div class="breadcrumbs" id="breadcrumbs">
					...
					<div class="widget-main"  id="chartsContainer" style="min-width: 1000px; max-width: 500px; margin: auto;height: 350px;"></div>
					...
					<thead>
						<tr>
						<th style="text-align:center;width:100px">序号</th><th style="text-align:center">生产工厂</th><th style="text-align:center">故障数量</th>
						</tr>
					</thead>
					<tbody></tbody>
					</table>
