				...
				<div class="page-content" style="position:fixed;top:38px;bottom:10px;width:100%;overflow-y:auto;padding-left: 0px;padding-right:12px;">
					<form class="form-horizontal" action="addProcessFaultMobile" id="processFault_form">
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select id="fault_level" name="fault_level" class="input-medium" style="width:100%">
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select id="is_batch" name="is_batch" class="input-medium" style="width:100%">
								<option value="">请选择</option>
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select id="factory" name="factory" class="input-medium" style="width:100%"></select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 control-label no-padding-right">车辆型号:</label>
							<div class="col-xs-9">
								<select id="bus_type" name="bus_type" class="input-medium" style="width:100%">
								</select>
							</div>
						</div>
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select id="response_factory" name="response_factory" class="input-small" style="width:100%"></select>
							</div>
						</div>
						<div class="form-group">
							<label class="col-xs-3 control-label no-padding-right">责任车间:</label>
							<div class="col-xs-9">
								<select id="workshop" name="workshop" class="input-small" style="width:100%"></select>
							</div>
						</div>
						<div class="form-group">
						...
						<div class="form-group">
							...
							<div class="col-xs-9">
								<select class="input-medium" id="resolve_result" name="resolve_result" style="width:100%"><option value="0">关闭</option><option value="1">受理</option></select>
							</div>
						</div>
						<div class="form-group">
