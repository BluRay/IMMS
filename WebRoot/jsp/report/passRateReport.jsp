...
<!-- 			<div class="breadcrumbs" id="breadcrumbs">
					...
					<div id="chartsContainer" style="min-width: 1200px; max-width: 500px; margin: auto;height: 280px;"></div>
	...
	<script type="text/javascript" src="../js/report/passRateReport.js"></script>
</html>
