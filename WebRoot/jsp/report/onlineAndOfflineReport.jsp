			...
			<div class="page-content">
					...
					<form id="search_form" class="well form-search">
						...
						<tr>
							...
							<td>
							<input id="search_date" placeholder="开始时间..." 
					...
					<div class="row">
						<div class="col-xs-12" style="width:100%">				
							...
							<table id="tableResult" class="table table-striped table-bordered table-hover" style="font-size: 12px;overflow-x:auto;width:1118px;table-layout:fixed">
						</table>
						</div>
					</div>
