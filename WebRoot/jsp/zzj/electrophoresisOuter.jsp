...
<body class="no-skin" style="font-family: 'Microsoft YaHei';">
	<div class="main-container" id="main-container" style="overflow-x:hidden; ">
			...
			<div id="dialog-edit" class="hide">
				<form id="" class="form-horizontal">
					...
					<div class="form-group">
						...
						<div  style="float:left;width:55%">
							<label style="float:left;width:30%" class="col-sm-3 control-label no-padding-right"><font size="3" color="red">*</font>&nbsp;发货数量</label>
							<div style="float:left;width:70%" class="col-sm-8">
					...
					<div class="form-group">
					    <div style="float:left;width:45%">
							<label style="float:left;width:30%" class="col-sm-3 control-label no-padding-right"><font size="3" color="red">*</font>&nbsp;发货日期</label>
							<div style="float:left;width:70%" class="col-sm-8">
		...
		<script src="../js/zzj/electrophoresisOuter.js"></script>
    </body>
</html>