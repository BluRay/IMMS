...
<body class="no-skin" style="font-family: 'Microsoft YaHei';">
	...
	<div class="main-container" id="main-container" style="height:100%">
				...
				<div class="page-content" style="position:fixed;top:38px;bottom:10px;width:100%;overflow-y:auto;padding-left: 0px;padding-right:12px;">
					...
					<form class="form-horizontal" id="scan_form">
						<div class="form-group has-info">
							...
							<div class="col-xs-9">
								...
								<span class="input-icon input-icon-right" style="width: 100%;">
										<input id="mat_description" type="text" class="input-medium"  value="${mat_description}"
						...
						<div class="form-group has-info">
							...
							<div class="col-xs-9">
								<span class="input-icon input-icon-right" style="width: 100%;">
										<input id="factory_name" type="text" class="input-medium"  value="${factory_name}"
										style="width:37%;height:30px;" readonly>
										<input id="delivery_workshop" type="text" class="input-medium"  value="${delivery_workshop}"
										style="width:37%;height:30px;" readonly>
										<input id="line_name" type="text" class="input-medium"  value="${line_name}"
										style="width:21%;height:30px;" readonly>			
								</span>
							</div>
						</div>
						<div class="form-group has-info">
							...
							<div class="col-xs-9">
								<span class="input-icon input-icon-right" style="width: 100%;">
										<input id="order_desc" type="text" class="input-medium"  value="${order_desc}"
										style="width:100%;height:30px;" readonly>			
								</span>
							</div>
						</div>
						...
						<div class="form-group has-info">
							...
							<div class="col-xs-9">
								<select id="receiving_workshop" class="input-medium" style="width:100%" disabled>
									<option value=''>${receiving_workshop}</option>
								</select>
							</div>
						</div>
						...
						<div class="form-group has-info">
							...
							<div class="col-xs-9">
								<input id="demand_quantity" type="text" class="input-medium" style="width:100%;height:30px;" value="${demand_quantity}" readonly/>
							</div>
						</div>
						<div class="form-group has-info">
							<label class="col-xs-3 control-label no-padding-right" style="text-align:right">累计供应数量:</label>
							<div class="col-xs-9">
								<input id="received_quantity" type="text" class="input-medium" style="width:100%;height:30px;" value="${received_quantity}" readonly/>
							</div>
						</div>
						...
						<div class="form-group has-info">
							...
							<div class="col-xs-9">
							    <input id="old_quantity" type="hidden" value="${quantity}" />
								<input id="quantity" type="text" value="${quantity}" class="input-medium" style="width:100%;height:30px;" />
							</div>
						</div>
		...
		<script src="../js/zzj/zzjWorkshopSupplyUpdate_Mobile.js"></script>
</div>
</body>
</html>