...
<body class="no-skin" style="font-family: 'Microsoft YaHei';">
	...
	<div class="main-container" id="main-container" style="overflow: hidden;">
		...
		<div class="main-content">		
					<form id="search_form" class="well form-search">
						...
						<tr>
							...
							<td>
								<select name="" id="search_factory" class="input-medium" style="width:110px;"></select>
							</td>
							<td style="text-align:right">线别：</td>
							<td>
								<select name="" id="search_line" class="input-medium" style="width:100px;"></select>
							</td>
							...
							<td>
								<select name="" id="search_batch" class="input-medium" style="width:100px;">
									<option value=''>全部</option>
								</select>
							</td>							
							<td style="text-align:right">物料描述：</td>
							<td >
								<input id="search_mat_desc" style="width:150px;height: 30px;" class="input-medium" type="text">
							</td>
						</tr>
						...
						<td>
							<select name="" id="search_workshop" class="input-medium" style="width:110px;"></select>
						</td>					
					...
					<td colspan=3>
								<input id="wdate_start" style="width:125px;height: 30px;" class="input-small" 
											onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" type="text">
								<span>-</span>
								<input id="wdate_end" style="width:125px;height: 30px;" class="input-small" 
											onclick="WdatePicker({dateFmt:'yyyy-MM-dd'})" type="text">
						</td>
						<td>
		...
		<script src="../js/zzj/matOutputReport.js"></script>
</body>
