...
<body class="no-skin" style="font-family: 'Microsoft YaHei';">
	...
	<div class="main-container" id="main-container" style="overflow: hidden;">
		...
		<div class="main-content">		
					<form id="search_form" class="well form-search">
						...
						<tr>
							...
							<td>
								<select name="" id="search_workshop" class="input-medium" style="width:80px;"></select>
							</td>	
							<td style="text-align:right">线别：</td>
							<td>
								<select name="" id="search_line" class="input-medium" style="width:80px;"></select>
							</td>
							<td style="text-align:right">生产工序：</td>
							<td >
							<select name="" id="search_process" class="input-medium" style="width:80px;">
						...
						<td>
							<select name="" id="search_batch" class="input-medium" style="width:80px;">
								<option value=''>全部</option>
							</select>
						</td>
						<td>
		...
		<script src="../js/zzj/matOutputBatchCountReport.js"></script>
</body>
