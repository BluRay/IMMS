...
<body class="no-skin" style="font-family: 'Microsoft YaHei';">
	...
	<div class="main-container" id="main-container" style="height:100%">
			...
			<!-- 路径和搜索框 -->
				...
				<div class="page-content" style="position:fixed;top:38px;bottom:10px;width:100%;overflow-y:auto;padding-left: 0px;padding-right:12px;">
					<form class="form-horizontal" id="scan_form">
						...
						<div class="form-group has-info">
							<label class="col-xs-3 control-label no-padding-right"><span style="color: red;">*</span>物料描述:</label>
							<div class="col-xs-9">
						...
						<div class="form-group has-info">
							<label class="col-xs-3 control-label no-padding-right"><span style="color: red;">*</span>自制件类别:</label>
							<div class="col-xs-9">
						...
						<div class="form-group has-info">
							...
							<div class="col-xs-9">
								<select id="specification" class="input-medium" style="width:100%">
									<!-- <option value=''>请选择</option> -->
								</select>
							</div>
						</div>
						...
						<div class="form-group has-info">
							...
							<div class="col-xs-9">
								<select id="filling_size" class="input-medium" style="width:100%">
									<!-- <option value=''>请选择</option> -->
								</select>
							</div>
						</div>
						...
						<div class="form-group has-info">
							<label class="col-xs-3 control-label no-padding-right" style="text-align:right"><span style="color: red;">*</span>订单:</label>
							<div class="col-xs-9">
								<input id="order" type="text" class="input-medium" style="width:100%;height:30px;" readonly/>
							</div>
						</div>
						
						<div class="form-group has-info">
							<label class="col-xs-3 control-label no-padding-right"><span style="color: red;">*</span>生产批次:</label>
							<div class="col-xs-9">
						...
						<div class="form-group has-info">
							<label class="col-xs-3 control-label no-padding-right"><span style="color: red;">*</span>生产数量:</label>
							<div class="col-xs-9">
								<input id="product_num" type="text" class="input-medium" style="width:100%;height:30px;" />
							</div>
						</div>
						
						<div class="form-group has-info">
							<label class="col-xs-3 control-label no-padding-right"><span style="color: red;">*</span>生产日期:</label>
							<div class="col-xs-9">
						...
						<div class="form-group has-info">
							<label class="col-xs-3 control-label no-padding-right"><span style="color: red;">*</span>生产工序:</label>
							<div class="col-xs-9">
						...
						<div class="form-group has-info">
							<label class="col-xs-3 control-label no-padding-right"><span style="color: red;">*</span>生产班组:</label>
							<div class="col-xs-9">
		...
		<script src="../js/zzj/matEnter_Mobile.js"></script>
</div>
</body>
</html>