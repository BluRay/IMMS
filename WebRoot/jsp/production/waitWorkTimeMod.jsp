...
<!-- 				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
					...
					<div class="row" style="margin-left: 0px;">
						<div id="zztree" class="col-xs-2" style="position: relative; left: 0; float: left; border: 1px solid #ccebf8; overflow: auto;color:#616161">
							<ul id="workGroupTree" class="ztree" style="padding-left:0px;margin-left: -10px;"></ul>
						</div>
						<div class="col-xs-10">
							<div class="row">
								<form id="form" class="well form-search " style="margin-left: 12px;margin-right: 12px;">
									 <table>
										<tr>
											<td>&nbsp;等待原因：</td>
											<td>
...
<!-- 											  &nbsp;<input type="button" class="btn btn-sm btn-warning" id="btnDelete" value="删除" style="margin-left: 2px;"></input> -->
							...
							<div class="row" >
								<div class="col-xs-12"  id="tableReusltDiv" style="">
									<table id="tableResult" class="table table-striped table-bordered table-hover" style="table-layout:fixed;font-size: 12px; overflow:auto;">
									</table>
								</div>
							</div>
						</div>
