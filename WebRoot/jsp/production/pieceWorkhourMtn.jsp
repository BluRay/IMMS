...
<!-- 				<div class="breadcrumbs ace-save-state" id="breadcrumbs">
				...
				<div class="row" style="margin-left: 0px;">
						...
						<div class="col-xs-10">
							<div class="row">
								<form id="form" class="well form-search " style="margin-left: 12px;display:none;margin-right: 12px;">
									 
									</form>
							</div>
							<div class="row" >
								<div class="col-xs-12"  id="tableReusltDiv" style="">
									<table id="tableResult" class="table table-striped table-bordered table-hover" style="word-wrap: break-word;font-size: 12px;">
									</table>
								</div>
							</div>
						</div>
