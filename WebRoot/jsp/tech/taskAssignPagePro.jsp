...
<html lang="zh-CN">
			...
			<div class="page-content">
				...
				<div id="dialog-assessModal" class="hide" style="align:center;width:700px;height:500px">
					...
					<tr style="height:40px">
						<td align="right" style="width:100px">技改任务：</td><td style="width:350px"><input type="text" style="width:350px" disabled="disabled" id="v_task_content" class="input-small" /></td>
					</tr>
					<tr style="height:40px">
						<td align="right" style="width:100px">技改单编号：</td><td style="width:350px"><input type="text" style="width:350px" disabled="disabled" id="v_tech_order_no" class="input-small" /></td>
					</tr>
					<tr style="height:40px">
						<td align="right" style="width:100px">切换方式：</td>
						<td style="width:280px">
							<input checked name="switch_mode" disabled="disabled" value="全部切换" type="radio"><span>全部切换&nbsp;&nbsp;</span>
							<input name="switch_mode" disabled="disabled" value="节点前切换" type="radio"><span>节点前切换&nbsp;&nbsp;</span>
							<input name="switch_mode" disabled="disabled" value="节点后切换" type="radio"><span>节点后切换&nbsp;&nbsp;</span>
						</td>
					</tr>
	...
	<script type="text/javascript" src="../js/tech/taskAssignPagePro.js"></script>
</html>
