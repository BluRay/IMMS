		...
		<div class="main-container" id="main-container">
			...
			<div id="dialog-edit" class="hide" style="align:center;width:780px;height:500px">
				...
				<table class="form-search">
					...
					<td width="160px"><input type="text" class="input-medium" style="margin-bottom: 0px;height:30px" id="edit_cardNumber"/></td>
					<td width="80px" style="text-align:right">操作月份：</td>
					<td width="160px"><input type="text" class="input-medium" style="margin-bottom: 0px;height:30px" id="edit_workDate" onclick="WdatePicker({dateFmt:'yyyy-MM'})"/></td>
