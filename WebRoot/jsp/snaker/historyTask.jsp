...
<html lang="zh-CN">
						...
						<table>
							<tr>
							    ...
							    <td>
								   ...
								   <input id="search_date_end" placeholder="结束时间..." style="width:90px" type="text" onClick="WdatePicker({el:'search_date_end',dateFmt:'yyyy-MM-dd'});">&nbsp;
							    </td>	
								<td>
	...
	<script type="text/javascript" src="../js/flow/historyTask.js"></script>
</html>
